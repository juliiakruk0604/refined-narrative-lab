...
const seo: ServiceContent = {
  ...
  position: {
    ...
    accent: "We build category authority that compounds for years after the engagement ends.",
    body: "The market is loaded with agencies optimising for impressions, anchor-text spam and AI-generated word count. That model dies on every Google update. Ours doesn't — because authority earned by real operators on real intent is the moat algorithms reward.",
  },
  pillars: [
    {
      n: "01",
  ...
  testimonial: {
    quote:
      "Six months in, organic is 64% of pipeline. It's the first agency relationship that actually built an asset instead of renting one.",
    who: "Anna K.",
...
const smm: ServiceContent = {
  ...
  outcomes: [
    {
      n: "01",
      title: "Founder becomes the channel.",
      body: "Audience follows the person, not the brand. The asset stays even if the company pivots.",
    },
    {
      n: "02",
      title: "Inbound from your ICP.",
      body: "Comments and DMs turn into qualified sales conversations within 60–90 days.",
    },
    {
      n: "03",
      title: "Lower paid dependency.",
      body: "Organic reach replaces a meaningful portion of paid social spend.",
    },
    {
      n: "04",
      title: "Recruiting magnet.",
      body: "Senior hires and operators come to you because they already follow the worldview.",
    },
  ],
  testimonial: {
    quote:
      "We went from 2k to 38k followers and, more importantly, from zero inbound to four qualified demos a week in 90 days.",
    who: "Marc L.",
...
const pr: ServiceContent = {
  ...
  outcomes: [
    {
      n: "01",
      title: "Buyers arrive pre-warmed.",
      body: "Sales cycles shorten because the founder is already a known voice in the category.",
    },
    {
      n: "02",
      title: "Hiring becomes easier.",
      body: "Operators reach out unprompted. Recruiting cost drops sharply.",
    },
    {
      n: "03",
      title: "Investor signal.",
      body: "Authority footprint becomes a measurable input to the next round.",
    },
    {
      n: "04",
      title: "Defensible voice.",
      body: "Once the founder owns a POV in the category, competitors can't outspend their way past it.",
    },
  ],
  testimonial: {
    quote:
      "Six placements in a quarter, two analyst notes, and a podcast circuit that put us on three buyer shortlists we never even pitched.",
    who: "Yulia M.",
...
const performance: ServiceContent = {
  ...
  outcomes: [
    {
      n: "01",
      title: "Payback windows shrink.",
      body: "Blended payback moves from 9–12 months to 4–6, freeing balance sheet for growth.",
    },
    {
      n: "02",
      title: "CAC stops drifting.",
      body: "Channel efficiency holds as spend scales — not the usual decay curve.",
    },
    {
      n: "03",
      title: "Margin clarity.",
      body: "Every channel has a contribution-margin number the CFO can defend in the board pack.",
    },
    {
      n: "04",
      title: "Compounding creative.",
      body: "Library of proven concepts means each new launch starts with a higher floor.",
    },
  ],
  testimonial: {
    quote:
      "They cut paid 30% in the first month, then doubled the volume of qualified pipeline by the third. Honest measurement was the unlock.",
    who: "Daniel R.",
    role: "CEO · Fintech",
  },
  accent: "#3ae8a6",
...
const brand: ServiceContent = {
  ...
  outcomes: [
    {
      n: "01",
      title: "Sales cycles compress.",
      body: "Clear positioning shortens deals because buyers understand the wedge fast.",
    },
    {
      n: "02",
      title: "Paid feels free.",
      body: "Sharper message lifts CTR, CVR, payback — without changing media.",
    },
    {
      n: "03",
      title: "Org alignment.",
      body: "Product, sales and marketing run from the same narrative. Less internal friction.",
    },
    {
      n: "04",
      title: "Defensible category.",
      body: "Once you own a position, competitors fight on price. You don't.",
    },
  ],
  testimonial: {
    quote:
      "The positioning work cleared a year of internal debate in six weeks. Our win rate went from 22% to 41% the next quarter.",
    who: "Sofia B.",
    role: "CEO · AI SaaS",
  },
  accent: "#e8a23a",
...
const design: ServiceContent = {
  ...
  outcomes: [
    {
      n: "01",
      title: "Conversion lifts hold.",
      body: "Surfaces ship measured. Lifts hold across cohorts — not just the launch week.",
    },
    {
      n: "02",
      title: "Brand recall climbs.",
      body: "Consistent identity across surfaces compounds into category recognition.",
    },
    {
      n: "03",
      title: "Faster shipping.",
      body: "Design system means in-house teams ship 2–3× faster without losing craft.",
    },
    {
      n: "04",
      title: "Investor signal.",
      body: "Editorial-grade surface tells the market you operate at a different level.",
    },
  ],
  testimonial: {
    quote:
      "The new site lifted demo requests 2.4× in the first month and the activation flow added 11 points to week-one retention.",
    who: "Andrii P.",
...
export const servicesList: ServiceContent[] = [brand, smm, pr, performance, seo, design];
